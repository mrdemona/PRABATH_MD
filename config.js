...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER.split("94702314166")
global.mongodb = process.env.MONGODB_URI || "Enter-MongoURI-HERE"
global.port= process.env.PORT || 5000
global.email = 'sam@sec.live'
global.github = 'https://github.com/prabathLK/PRABATH-MD'
global.location = 'Sultanpur IN'
global.gurl = 'https://instagram.com/demonpsycho404' // add your username
global.devs = '94702314166';
global.website = 'https://github.com/prabathLK/PRABATH-MD' //wa.me/+94702314166
...
module.exports = {
  ...
  alivepic: process.env.ALIVE_IMG || 'https://i.ibb.co/LvCvhhS/94-77-275-7662-20220813-161305.jpg',
  alivemsj: process.env.ALIVE_MSJ || '*POWERD BY SIHILEL* 🎊',
  ownername:process.env.OWNER_NAME || 'Mr Demon✔',
